...
1. 页面访问：4,432
   访问详情：/home 976 次、/level 834 次、/arena 797 次、/quest/Levelup-ocean-Q0804 14,958 次、/quest/TokenB-Quest-TKB01 7,964 次
2. 访问会话：458
3. 新用户注册：15
4. 活跃用户：198
5. 完成 Quest 用户：13
...
class NUWorldParserTest(unittest.TestCase):
    def test_parse_nuworld_report(self):
        ...
        self.assertEqual(fields["访问详情：/quest/TokenB-Quest-TKB01"], 7964)
